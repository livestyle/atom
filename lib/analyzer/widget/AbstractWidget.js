...
module.exports = class AbstractWidget {
    ...
    decorate(value) {
        ...
        if (props.type === 'livestyle-widget') {
            ...
            let widget = new LiveStyleWidget().initialize(this.editor, view, this.marker, props);
            // widget.appendChild(this.elem);
            return widget;
        }
        ...
        if (props.type === 'block-overlay') {
            ...
            props.type = 'block';
            let view = atom.views.getView(this.editor);
            let startPos = view.pixelPositionForBufferPosition(this.marker.getStartBufferPosition());
            let endPos = view.pixelPositionForBufferPosition(this.marker.getEndBufferPosition());
